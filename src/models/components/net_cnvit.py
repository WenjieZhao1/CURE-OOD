...
class UNETR(nn.Module):
    ...
    def __init__(
        ...
        if hparams['n_dense'] <=0:
            ...
            self.mtlr1 = MTLR(256 + hparams['hidden_size'] + n_clin_var, hparams['time_bins'])
            self.mtlr2 = MTLR(256 + hparams['hidden_size'] + n_clin_var, hparams['time_bins'])
            self.mtlr3 = MTLR(256 + hparams['hidden_size'] + n_clin_var, hparams['time_bins'])
            self.mtlr4 = MTLR(256 + hparams['hidden_size'] + n_clin_var, hparams['time_bins'])

        elif hparams['n_dense'] ==1:
            self.fc_layers1 = nn.Sequential(nn.Linear(256 + hparams['hidden_size'] + n_clin_var, 64*hparams['dense_factor']), 
            ...
            self.fc_layers1 = nn.Sequential(nn.Linear(256 + hparams['hidden_size'] + n_clin_var , 128*hparams['dense_factor']), 
    ...
    def forward(self, sample):
        ...
        x = torch.cat((self.cnn(img), x, clin_var), dim=1)
