...
class UNETR(nn.Module):
    ...
    def forward(self, sample):
        ...
        risk_out1, seprate_logits1 = self.mtlr1(x)
        risk_out2, seprate_logits2 = self.mtlr2(x)
        risk_out3, seprate_logits3 = self.mtlr3(x)
        risk_out4, seprate_logits4 = self.mtlr4(x)
        return risk_out1,  risk_out2, risk_out3, risk_out4, feat_norm, seprate_logits1, seprate_logits2, seprate_logits3, seprate_logits4
